...
class shit3:
  ...
  def main(self):
      ...
      self.sug(g + 'Ijen Sinaga"')
      self.sug(g + 'Nicoleus Sitorus')
      self.sug(g + 'Wahyu GPS') 
      self.sug(g + 'BatakCyber')
      self.sug(g + 'COOL hACKER')
      self.sug(g + 'Hottua Haro')
      self.sug(g + 'SAMOSIR_TEAM Indonesia')
      self.sug(g + 'BATAK_NESE Security')
      self.sug(g + 'Association Batak Indonesian Right Wing')
      self.sug(g + 'And All Member Indonesia Security Lite')
      self.sug(g + '.....HORAS HITA SUDE....')
      self.sug(g + 'tunggu 8 detik Biar GetOut')
      time.sleep(1)
      print '-'*42
      self.sug(w + '-' * 42)
